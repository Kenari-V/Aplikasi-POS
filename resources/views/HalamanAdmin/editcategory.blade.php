...
<head>
    ...
    <title>Ohio Edit Category</title>
</head>
<body>
<!-- navbar  -->
...
<div class="content-bg">
    <div class="content-tambah-product">
        <form action="/Category/{{$dataCategory->id_category}}" method="POST" class="form-add-product">
            @method('put')
            @csrf
            <div class="border-header-add-product">
                <div class="text-header-add-product">Tambah Category</div>
            </div>
            <div class="form-group">
                <label for="Nama Product" class="input-product-text">Nama Category : </label>
                <input type="text" name="nama_category" class="box-input-create" placeholder="Silahkan Masukan Nama Category" value="{{$dataCategory->nama_category}}">
            </div>
