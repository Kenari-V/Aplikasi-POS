...
<head>
    ...
    <link rel="stylesheet" href="{{asset('assets/css/editusers.css')}}">
</head>
<body>
    ...
    <div class="content-bg">
        <div class="content-tambah-product">
            <form action="/Role/{{$dataUsers->id_users}}" method="POST">
                @method('put')
                @csrf
            <div class="border-header-add-product">
                <div class="text-header-add-product">Edit Users</div>
            </div>
            <div class="form-group">
                <label for="Nama Product" class="input-product-text">Nama User : </label>
                <input type="text" name="name" class="box-input-create" placeholder="Silahkan Masukan Nama " value="{{$dataUsers->name}}">
            </div>
            <div class="form-group">
                <label for="Harga Product" class="input-product-text">Email : </label>
                <input type="text" name="email" class="box-input-create" placeholder="Silahkan Masukan Email " value="{{$dataUsers->email}}">
            </div>
            <div class="form-group">
