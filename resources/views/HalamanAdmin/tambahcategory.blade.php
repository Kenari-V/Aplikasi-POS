...
<div class="content-bg">
    <div class="content-tambah-product">
        <form action="/Category/tambah-category" method="POST" class="form-add-product">
            @csrf
            ...
            <div class="form-group">
                ...
                <input type="text" name="nama_category" class="box-input-create" placeholder="Silahkan Masukan Nama Category">
            </div>
