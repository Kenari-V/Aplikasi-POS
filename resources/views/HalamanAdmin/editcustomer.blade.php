...
<head>
    ...
    <link rel="stylesheet" href="{{asset('assets/css/editcustomer.css')}}">
    <title>Ohio Edit Customer</title>
</head>
<body>
<!-- navbar  -->
...
<div class="content-bg">
    <div class="content-tambah-product">
        <form action="/Customer/{{$dataCustomer->id_customer}}" method="POST" class="form-add-product">
            @method('put')
            @csrf
            ...
            <div class="form-group">
                ...
                <input type="text" name="nama_customer" class="box-input-create" placeholder="Silahkan Masukan Nama Customer" value="{{$dataCustomer->nama_customer}}">
            </div>
            <div class="form-group">
                <label for="Harga Product" class="input-product-text">Contact : </label>
                <input type="text" name="contact" class="box-input-create" placeholder="Silahkan Masukan contact Customer" value="{{$dataCustomer->contact}}">
            </div>
            <div class="form-group">
                <label for="Qty Product" class="input-product-text">Address : </label>
                <input type="text" name="address" class="box-input-create" placeholder="Silahkan Masukan Address Customer" value="{{$dataCustomer->address}}">
            </div>
            <div class="submit-create-data">
                <button type="submit" class="button-submit-create">Simpan</button>
            </div>
            <div class="submit-cancel-data">
                <a type="submit" href="/Customer" class="button-cancel-create">Cancel</a>
            </div>
        </form>
    </div>
</div>
